...
$(document).ready(function() {
	...
	$(".addNewMeta").unbind('click').click(function(e) {
	    ...
	    // $('.gs-color').wpColorPicker();
	    $(this).closest('.containerAddNew').find('.repeaterWrapper').last().find('.wp-picker-container').each(function(){
	    	$(this).find('.gs-color').appendTo($(this).closest('.contentMetaDesc'));
	    	$(this).remove();
	    	$('.gs-color').wpColorPicker();
	    	$('.gs-color').closest('.wp-picker-container').find('button').css('display', 'block');
